...
public class DinnerModel implements IDinnerModel{
	...
	public DinnerModel(){
		...
		Ingredient dish1ing1 = new Ingredient("eggs",0.5,"st",1);
	...
	Scanner NumberOfGuest_input = new Scanner(System.in);
	/**
	...
	public float getTotalMenuPrice() {
		// TODO Auto-generated method stub
		Set<Ingredient> allIngredient = getAllIngredients(); 
			double price = 0;
			for (Ingredient i : allIngredient){
